  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full' style={{backgroundImage: 'linear-gradient(115deg, #9F7AEA, #FEE2FE)'}}>
      <div className='hidden sm:block'>
        <img className='w-full h-full object-cover' alt='backgroundimg' src='https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8Y29kaW5nJTIwYXN0aGV0aWN8ZW58MHx8MHx8&auto=format&fit=crop&w=1200&q=60' />
      </div>
